...
public:
     ...
     */
    GlobalState(const IPLhandle &context,const IPLRenderingSettings& renderingSettings, 
     ...
     */
    static void create(const IPLhandle &context,const IPLRenderingSettings& renderingSettings, 
                       const IPLAudioFormat& audioFormat);
